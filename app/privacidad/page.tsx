...
const SECTIONS = [
  ...
  {
    title: "Actividad del modo viaje",
    body: "Al iniciar un viaje enviamos a Supabase un identificador aleatorio de ese viaje, las rutas y la hora de inicio. Si pulsas ‘Llegué a mi destino’, registramos también la confirmación de llegada. Cerrar el seguimiento no confirma una llegada. Estos registros no contienen coordenadas, cuentas ni identificadores permanentes del dispositivo. Los comprobantes individuales se eliminan después de 30 días al recibirse nueva actividad; conservamos los totales diarios por ruta. Si no hay conexión, el dispositivo conserva hasta 20 envíos pendientes para reintentarlos durante 24 horas al usar el mapa. Publicamos solo cifras agregadas, que representan actividad dentro de UruGo y no aforos de pasajeros."
  },
  {
